...
const Admin = () =>
  import("../views/Admin.vue").catch(() => {
    window.location.reload();
  });
const SettingsView = () =>
  import("../views/SettingsView.vue").catch(() => {
    window.location.reload();
  });
const SongSelector = () =>
  import("../views/SongSelector.vue").catch(() => {
    window.location.reload();
  });
const PresentationView = () =>
  import("../views/PresentationView.vue").catch(() => {
    window.location.reload();
  });
const SongViewer = () =>
  import("../views/SongViewer.vue").catch(() => {
    window.location.reload();
  });
const ContributorView = () =>
  import("../views/ContributorView.vue").catch(() => {
    window.location.reload();
  });

const CompleteSearch = () =>
  import("../views/dashboard/CompleteSearch.vue").catch(() => {
    window.location.reload();
  });

const Success = () =>
  import("../views/Success.vue").catch(() => {
    window.location.reload();
  });

const NotFound = () =>
  import("../views/NotFound.vue").catch(() => {
    window.location.reload();
  });
const VerifyEmail = () =>
  import("../views/VerifyEmail.vue").catch(() => {
    window.location.reload();
  });

const SheetMusic = () =>
  import("../views/SheetMusic.vue").catch(() => {
    window.location.reload();
  });
const SongStatistics = () =>
  import("../views/statistics/SongStatistics.vue").catch(() => {
    window.location.reload();
  });
const CreditSong = () =>
  import("../views/CreditSong.vue").catch(() => {
    window.location.reload();
  });
const RedeemToken = () =>
  import("../views/RedeemToken.vue").catch(() => {
    window.location.reload();
  });
const PrintView = () =>
  import("../views/PrintView.vue").catch(() => {
    window.location.reload();
  });

const FavoritesView = () =>
  import("../views/Favorites.vue").catch(() => {
    window.location.reload();
  });
