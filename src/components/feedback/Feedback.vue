<template>
  <a
    href="mailto:support@songtreasures.org?subject=SongTreasures Feedback"
    aria-label="Feedback button"
    title="Feedback"
    class="p-1 mr-2 rounded-md focus-visible:ring-2 focus-visible:ring-primary hover:bg-black/5 dark:hover:bg-white/10"
  >
