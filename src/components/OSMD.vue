  ...
  <BaseCard>
    <template #header>
      <div>
        ...
        <button
          v-if="onSongViewer"
          class="flex float-right text-red-700"
          @click="close()"
        >
          <XIcon class="w-4 h-4" />
        </button>
        <div class="flex">
            ...
            <BaseDropdown origin="left" :label="options?.clef" class="">
              <div class="max-h-64 overflow-y-auto shadow-scroll">
                <button
                  ...
                  @click="setClef('bass')"
                >
                  <span class="font-semibold"> Bass </span>
                </button>
                <button
                  :class="{
                ...
                >
                  <span class="font-semibold"> Treble </span>
                </button>
                <button
                  :class="{
          ...
          <label
            class="mr-2"
            v-if="sheetDetails && sheetDetails.instruments.length > 1"
          >
            <span class="text-sm text-gray-500">{{
              $t("common_instruments")
            }}</span>
            <BaseDropdown :label="instrumentsLabel">
              <ListSelect
                :data="
                  sheetDetails.instruments.map((i) => ({
                    display: i,
                    value: i,
          ...
          <label class="mr-2">
            ...
            <select
              class="bg-white p-2 rounded-md border border-black/20 pr-8 dark:bg-secondary dark:border-white/20"
              name="zoom"
              id="zoom"
              v-model="size"
              @change="load"
            >
              <option :key="`size-sm`" value="sm">Small</option>
              <option :key="`size-md`" value="md">Medium</option>
              <option :key="`size-lg`" value="lg">Large</option>
            </select>
          </label>
          <div class="">
